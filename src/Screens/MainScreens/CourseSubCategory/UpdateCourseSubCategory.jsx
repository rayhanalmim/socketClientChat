...
export default function UpdateCourseSubCategory({ id = null, setEditModal, toggleFetch, ...props }) {
  ...
  async function fetchCategoryData(id) {
    try {
      setIsLoading(true);
      const response = await axiosInstance.get(`${COURSE_SUB_CATEGORY_APIS}/${id}`);
  ...
  async function onSubmit(data) {
    ...
    try {
      ...
      const response = await axiosInstance.patch(`${COURSE_SUB_CATEGORY_APIS}/${id}`, formData)
