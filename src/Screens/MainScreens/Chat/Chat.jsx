...
import { Header } from "@antopolis/admin-component-library/dist/elements";
...
export default function Chat() {
  ...
  return (
    <section className="flex h-full p-5 gap-6">
            ...
            return (
              <React.Fragment key={id}>
                <button
                  type="button"
                  className={cn(
                    `-mx-1 flex rounded-md px-2 py-2 text-left text-sm hover:bg-secondary/75`,
                ...
                {/* <Separator className='my-1' /> */} <hr></hr>
              </React.Fragment>
            );
          })}
        </div>
      ...
      <div
        className={cn(
          "w-full flex-col rounded-md border bg-primary-foreground shadow-sm transition-all duration-200 sm:static sm:z-auto sm:flex",
